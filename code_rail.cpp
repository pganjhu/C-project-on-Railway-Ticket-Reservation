// A PROGRAM ON RAILWAY TICKET RESERVATION
//HEADER FILES USED
#include<stdio.h>
#include<conio.h>
#include<stdlib.h>
...
/*CLASS TO ACCEPT INFORMATION ABOUT TRAIN AND TRAVEL*/
class detail
{
public:
int tno;
...
// CLOSE OF CLASS DETAILS
/*TO ACCEPT AND DISPLAY DETAILS OF PASSANGER’S*/
class reser
{
public:
int pnr;
...
// CLOSE OF CLASS RESER
/*CLASS TO CANCEL TICKETS PURCHASED*/
class canc
{
31
public:
